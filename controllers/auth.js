...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
    ...
    const message = `You are receiving this email because you (or someone else) has request a reset of a password, Please make a put request to \n\n${resetUrl}`
    ...
    try {
        ...
        // Save without running the validator
        await user.save({validateBeforeSave: false})
